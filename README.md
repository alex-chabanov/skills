...
- **[improve](./skills/engineering/improve/SKILL.md)** — Survey a codebase read-only as a senior advisor and produce prioritized, self-contained handoff plans for cheaper executor models to implement. Audits bugs, security, performance, tests, tech debt, migrations, and direction; mobile-aware (Android/Kotlin & Apple/Swift).
- **[karpathy-guidelines](./skills/engineering/karpathy-guidelines/SKILL.md)** — Behavioral guidelines from Karpathy's LLM-coding observations: surface assumptions, prefer simplicity, make surgical changes, define verifiable success criteria.
